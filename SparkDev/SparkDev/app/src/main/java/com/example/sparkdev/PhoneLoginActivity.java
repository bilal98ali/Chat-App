...
public class PhoneLoginActivity {
    //under EditText InputPhoneNumber, InputVerificationCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //under setContentView(R.layout.activity_phone_login);

        mAuth = FirebaseAuth.getInstance();

        //underInputVerificationCode = (EditText)...
    ...
    SendVerificationCodeButton.setOnClickListener(new View.OnClickListener(){
        ...
        public void onClick(View view){
            //delete first five lives of code
    ...
    callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
        ...
        @Override
        public void onVertificationFailed(FirebaseException e){
            loadingBar.dismiss();
